...
Public Class connGLinkTP8
    '--GLink Methods and Variables for connecting and controlling the FAMIS TP8 screens--
    ...
    'Private Const TRANSMIT As Glink.GlinkKeyEnum = Glink.GlinkKeyEnum.GlinkKey_TRANSMIT '--Changed 11/5/08 due to state changes--
    Private Const TRANSMIT As Glink.GlinkKeyEnum = Glink.GlinkKeyEnum.GlinkKey_ENTER
    ...
    Public Sub Disconnect()
        '--Disconnects GLink--
        'If GLAPI.isConnected Then GLAPI.Disconnect() '--Changed 11/5/08 due to state changes--
        If GLAPI.isConnected Then GLAPI.stop()
