Public Class Existing_105Form
    ...
    Private Sub Exisiting_105Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub Exisiting_105FormFormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        'Dim i As Integer
        Transfer105A()
        Transfer105A1()
    ...
    Private Sub Fill_FormB_VRP()
        ...
        If numChildren > 0 Then
            ...
            While SQLReader.Read
                ...
                FamisCaseChild(i).QG.SetData(SQLReader.GetDateTime(7))
                ...
                FamisCaseChild(i).QK.SetData(SQLReader.GetDateTime(11))
                ...
                FamisCaseChild(i).RH2.SetData(SQLReader.GetString(24))
                ...
                FamisCaseChild(i).SN.SetData(SQLReader.GetDateTime(33))
                ...
                FamisCaseChild(i).TL.SetData(SQLReader.GetDateTime(65))
                ...
                FamisCaseChild(i).TE.SetData(SQLReader.GetDateTime(82))
    ...
    Private Sub AddEvents(ByVal ctrlparent As Control)
        ...
        For Each ctrl In ctrlparent.Controls
            If TypeOf ctrl Is TextBox Then
                ...
                AddHandler ctrl.TextChanged, AddressOf ClearNullDate
            End If
    ...
    End Sub
    Private Sub ClearNullDate(ByVal sender As Object, ByVal e As EventArgs)
        If DirectCast(sender, TextBox).Text = "111900  " Or DirectCast(sender, TextBox).Text = "01011900" Or DirectCast(sender, TextBox).Text = "1/1/1900" Then DirectCast(sender, TextBox).Text = "".PadLeft(DirectCast(sender, TextBox).MaxLength, " ")
    End Sub
